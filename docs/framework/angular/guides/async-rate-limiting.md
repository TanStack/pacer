---
title: Angular Async Rate Limiting Guide
...
The focused snippets later in this guide use `injectAsyncRateLimiter` and assume they run inside an Angular injection context.
