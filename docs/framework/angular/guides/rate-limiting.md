---
title: Angular Rate Limiting Guide
id: rate-limiting
---
...
```ts
const limiter = injectRateLimiter(sendEvent, {
  limit: 3,
  window: 1000,
  windowType: 'fixed',
})
...
The focused snippets later in this guide use `injectRateLimiter` and assume they run inside an Angular injection context.
