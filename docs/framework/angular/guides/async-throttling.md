---
title: Angular Async Throttling Guide
id: async-throttling
---
...
The focused snippets later in this guide use `injectAsyncThrottler` and assume they run inside an Angular injection context.
