---
title: Angular Async Queuing Guide
id: async-queuing
---
...
The focused snippets later in this guide use `injectAsyncQueuer` and assume they run inside an Angular injection context.
...
```ts
const queue = injectAsyncQueuer(processJob, {
  started: false,
  concurrency: 2,
