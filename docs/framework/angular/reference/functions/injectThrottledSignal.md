...
Defined in: [throttler/injectThrottledSignal.ts:71](https://github.com/TanStack/pacer/blob/main/packages/angular-pacer/src/throttler/injectThrottledSignal.ts#L71)
