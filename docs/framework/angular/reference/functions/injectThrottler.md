...
Defined in: [angular-pacer/src/throttler/injectThrottler.ts:109](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/throttler/injectThrottler.ts#L109)
