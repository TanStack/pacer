...
Defined in: [angular-pacer/src/throttler/injectThrottler.ts:85](https://github.com/theVedanta/pacer/blob/main/packages/angular-pacer/src/throttler/injectThrottler.ts#L85)
