...
Defined in: [angular-pacer/src/async-batcher/injectAsyncBatcher.ts:96](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/async-batcher/injectAsyncBatcher.ts#L96)
