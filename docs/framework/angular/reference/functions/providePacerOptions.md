...
Defined in: [angular-pacer/src/provider/pacer-provider.ts:33](https://github.com/theVedanta/pacer/blob/main/packages/angular-pacer/src/provider/pacer-provider.ts#L33)
