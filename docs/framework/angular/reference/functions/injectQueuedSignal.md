...
Defined in: [angular-pacer/src/queuer/injectQueuedSignal.ts:43](https://github.com/theVedanta/pacer/blob/main/packages/angular-pacer/src/queuer/injectQueuedSignal.ts#L43)
