...
Defined in: [angular-pacer/src/queuer/injectQueuer.ts:90](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/queuer/injectQueuer.ts#L90)
