...
Defined in: [angular-pacer/src/throttler/injectThrottledCallback.ts:39](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/throttler/injectThrottledCallback.ts#L39)
