...
Defined in: [angular-pacer/src/async-rate-limiter/injectAsyncRateLimiter.ts:66](https://github.com/TanStack/pacer/blob/main/packages/angular-pacer/src/async-rate-limiter/injectAsyncRateLimiter.ts#L66)
