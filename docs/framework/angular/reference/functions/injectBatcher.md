...
Defined in: [angular-pacer/src/batcher/injectBatcher.ts:85](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/batcher/injectBatcher.ts#L85)
