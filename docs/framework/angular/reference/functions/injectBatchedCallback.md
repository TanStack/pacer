...
Defined in: [angular-pacer/src/batcher/injectBatchedCallback.ts:40](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/batcher/injectBatchedCallback.ts#L40)
