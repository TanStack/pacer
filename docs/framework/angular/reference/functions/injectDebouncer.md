...
Defined in: [angular-pacer/src/debouncer/injectDebouncer.ts:85](https://github.com/theVedanta/pacer/blob/main/packages/angular-pacer/src/debouncer/injectDebouncer.ts#L85)
