...
Defined in: [debouncer/injectDebouncedCallback.ts:40](https://github.com/theVedanta/pacer/blob/main/packages/angular-pacer/src/debouncer/injectDebouncedCallback.ts#L40)
