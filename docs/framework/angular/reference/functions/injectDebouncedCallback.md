...
Defined in: [angular-pacer/src/debouncer/injectDebouncedCallback.ts:40](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/debouncer/injectDebouncedCallback.ts#L40)
