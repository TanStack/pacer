...
Defined in: [angular-pacer/src/rate-limiter/injectRateLimiter.ts:114](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/rate-limiter/injectRateLimiter.ts#L114)
