...
Defined in: [rate-limiter/injectRateLimiter.ts:99](https://github.com/TanStack/pacer/blob/main/packages/angular-pacer/src/rate-limiter/injectRateLimiter.ts#L99)
