...
Defined in: [async-throttler/injectAsyncThrottler.ts:71](https://github.com/TanStack/pacer/blob/main/packages/angular-pacer/src/async-throttler/injectAsyncThrottler.ts#L71)
