...
Defined in: [angular-pacer/src/async-throttler/injectAsyncThrottler.ts:98](https://github.com/klink-ing/pacer/blob/main/packages/angular-pacer/src/async-throttler/injectAsyncThrottler.ts#L98)
