...
Defined in: [angular-pacer/src/async-queuer/injectAsyncQueuer.ts:69](https://github.com/TanStack/pacer/blob/main/packages/angular-pacer/src/async-queuer/injectAsyncQueuer.ts#L69)
