...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedCallback.ts:59](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedCallback.ts#L59)
