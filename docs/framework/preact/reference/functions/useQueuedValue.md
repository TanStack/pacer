...
Defined in: [preact-pacer/src/queuer/useQueuedValue.ts:103](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/queuer/useQueuedValue.ts#L103)
