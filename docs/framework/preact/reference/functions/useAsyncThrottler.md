...
Defined in: [preact-pacer/src/async-throttler/useAsyncThrottler.ts:213](https://github.com/TanStack/pacer/blob/main/packages/preact-pacer/src/async-throttler/useAsyncThrottler.ts#L213)
