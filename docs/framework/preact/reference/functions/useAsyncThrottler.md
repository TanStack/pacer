...
Defined in: [preact-pacer/src/async-throttler/useAsyncThrottler.ts:196](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/async-throttler/useAsyncThrottler.ts#L196)
