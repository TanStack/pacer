...
Defined in: [preact-pacer/src/async-throttler/useAsyncThrottler.ts:225](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/async-throttler/useAsyncThrottler.ts#L225)
