...
Defined in: [preact-pacer/src/async-batcher/useAsyncBatcher.ts:235](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/async-batcher/useAsyncBatcher.ts#L235)
