...
Defined in: [preact-pacer/src/debouncer/useDebouncedCallback.ts:42](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/debouncer/useDebouncedCallback.ts#L42)
