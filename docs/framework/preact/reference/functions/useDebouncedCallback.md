...
Defined in: [preact-pacer/src/debouncer/useDebouncedCallback.ts:42](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/debouncer/useDebouncedCallback.ts#L42)
