...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedState.ts:108](https://github.com/ghostd/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedState.ts#L108)
