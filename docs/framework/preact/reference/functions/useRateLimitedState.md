...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedState.ts:108](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedState.ts#L108)
