...
Defined in: [preact-pacer/src/throttler/useThrottledCallback.ts:43](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/throttler/useThrottledCallback.ts#L43)
