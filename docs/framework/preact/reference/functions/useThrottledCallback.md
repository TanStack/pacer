...
Defined in: [preact-pacer/src/throttler/useThrottledCallback.ts:43](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/throttler/useThrottledCallback.ts#L43)
