...
Defined in: [preact-pacer/src/debouncer/useDebouncedState.ts:79](https://github.com/klink-ing/pacer/blob/main/packages/preact-pacer/src/debouncer/useDebouncedState.ts#L79)
