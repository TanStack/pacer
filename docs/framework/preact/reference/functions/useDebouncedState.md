...
Defined in: [preact-pacer/src/debouncer/useDebouncedState.ts:82](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/debouncer/useDebouncedState.ts#L82)
...
`DebouncerOptions`\<`Dispatch`\<`StateUpdater`\<`TValue`\>\>\>
