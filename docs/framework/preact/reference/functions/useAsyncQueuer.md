...
Defined in: [preact-pacer/src/async-queuer/useAsyncQueuer.ts:235](https://github.com/ghostd/pacer/blob/main/packages/preact-pacer/src/async-queuer/useAsyncQueuer.ts#L235)
