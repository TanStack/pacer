...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedValue.ts:97](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedValue.ts#L97)
