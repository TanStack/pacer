...
Defined in: [preact-pacer/src/rate-limiter/useRateLimitedValue.ts:97](https://github.com/ghostd/pacer/blob/main/packages/preact-pacer/src/rate-limiter/useRateLimitedValue.ts#L97)
