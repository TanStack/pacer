...
Defined in: [preact-pacer/src/throttler/useThrottledState.ts:91](https://github.com/ghostd/pacer/blob/main/packages/preact-pacer/src/throttler/useThrottledState.ts#L91)
