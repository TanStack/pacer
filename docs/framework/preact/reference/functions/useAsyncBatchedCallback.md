...
Defined in: [preact-pacer/src/async-batcher/useAsyncBatchedCallback.ts:43](https://github.com/theVedanta/pacer/blob/main/packages/preact-pacer/src/async-batcher/useAsyncBatchedCallback.ts#L43)
