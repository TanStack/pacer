...
Defined in: [preact-pacer/src/async-batcher/useAsyncBatchedCallback.ts:42](https://github.com/ghostd/pacer/blob/main/packages/preact-pacer/src/async-batcher/useAsyncBatchedCallback.ts#L42)
