---
title: Vanilla Rate Limiting Guide
id: rate-limiting
---
...
Use [async rate limiting](./async-rate-limiting.md) for Promise results and configurable async error handling.
...
See the [`RateLimiter` API reference](../../../reference/classes/RateLimiter.md) for complete option and state types.
