...
Defined in: [react-pacer/src/rate-limiter/useRateLimiter.ts:179](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/rate-limiter/useRateLimiter.ts#L179)
