...
Defined in: [react-pacer/src/throttler/useThrottler.ts:168](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/throttler/useThrottler.ts#L168)
