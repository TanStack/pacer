...
Defined in: [react-pacer/src/rate-limiter/useRateLimitedState.ts:107](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/rate-limiter/useRateLimitedState.ts#L107)
