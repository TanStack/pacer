...
Defined in: [react-pacer/src/rate-limiter/useRateLimitedState.ts:107](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/rate-limiter/useRateLimitedState.ts#L107)
