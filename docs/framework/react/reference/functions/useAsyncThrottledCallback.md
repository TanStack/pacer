...
Defined in: [react-pacer/src/async-throttler/useAsyncThrottledCallback.ts:42](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/async-throttler/useAsyncThrottledCallback.ts#L42)
