...
Defined in: [react-pacer/src/debouncer/useDebouncedCallback.ts:42](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/debouncer/useDebouncedCallback.ts#L42)
