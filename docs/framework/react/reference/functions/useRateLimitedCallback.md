...
Defined in: [react-pacer/src/rate-limiter/useRateLimitedCallback.ts:59](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/rate-limiter/useRateLimitedCallback.ts#L59)
