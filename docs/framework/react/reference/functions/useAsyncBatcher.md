...
Defined in: [react-pacer/src/async-batcher/useAsyncBatcher.ts:235](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/async-batcher/useAsyncBatcher.ts#L235)
