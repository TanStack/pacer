...
Defined in: [react-pacer/src/async-batcher/useAsyncBatcher.ts:235](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/async-batcher/useAsyncBatcher.ts#L235)
