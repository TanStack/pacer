...
Defined in: [react-pacer/src/throttler/useThrottledCallback.ts:43](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/throttler/useThrottledCallback.ts#L43)
