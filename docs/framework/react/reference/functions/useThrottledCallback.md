...
Defined in: [react-pacer/src/throttler/useThrottledCallback.ts:43](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/throttler/useThrottledCallback.ts#L43)
