...
Defined in: [react-pacer/src/async-queuer/useAsyncQueuedState.ts:151](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/async-queuer/useAsyncQueuedState.ts#L151)
