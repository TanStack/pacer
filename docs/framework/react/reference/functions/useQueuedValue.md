...
Defined in: [react-pacer/src/queuer/useQueuedValue.ts:103](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/queuer/useQueuedValue.ts#L103)
