...
Defined in: [react-pacer/src/async-queuer/useAsyncQueuer.ts:58](https://github.com/TanStack/pacer/blob/main/packages/react-pacer/src/async-queuer/useAsyncQueuer.ts#L58)
