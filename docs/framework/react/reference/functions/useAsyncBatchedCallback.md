...
Defined in: [react-pacer/src/async-batcher/useAsyncBatchedCallback.ts:42](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/async-batcher/useAsyncBatchedCallback.ts#L42)
