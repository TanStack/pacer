...
Defined in: [react-pacer/src/async-batcher/useAsyncBatchedCallback.ts:42](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/async-batcher/useAsyncBatchedCallback.ts#L42)
