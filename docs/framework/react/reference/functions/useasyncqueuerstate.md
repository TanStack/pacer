...
Defined in: [react-pacer/src/async-queuer/useAsyncQueuerState.ts:50](https://github.com/TanStack/bouncer/blob/main/packages/react-pacer/src/async-queuer/useAsyncQueuerState.ts#L50)
