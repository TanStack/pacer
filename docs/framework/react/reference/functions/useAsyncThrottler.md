...
Defined in: [react-pacer/src/async-throttler/useAsyncThrottler.ts:196](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/async-throttler/useAsyncThrottler.ts#L196)
