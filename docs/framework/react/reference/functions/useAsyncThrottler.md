...
Defined in: [react-pacer/src/async-throttler/useAsyncThrottler.ts:225](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/async-throttler/useAsyncThrottler.ts#L225)
