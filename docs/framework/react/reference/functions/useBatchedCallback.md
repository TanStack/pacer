...
Defined in: [react-pacer/src/batcher/useBatchedCallback.ts:40](https://github.com/ghostd/pacer/blob/main/packages/react-pacer/src/batcher/useBatchedCallback.ts#L40)
