...
Defined in: [react-pacer/src/batcher/useBatchedCallback.ts:40](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/batcher/useBatchedCallback.ts#L40)
