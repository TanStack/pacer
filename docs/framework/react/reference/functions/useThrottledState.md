...
Defined in: [react-pacer/src/throttler/useThrottledState.ts:90](https://github.com/klink-ing/pacer/blob/main/packages/react-pacer/src/throttler/useThrottledState.ts#L90)
