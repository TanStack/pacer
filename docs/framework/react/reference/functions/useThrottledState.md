...
Defined in: [react-pacer/src/throttler/useThrottledState.ts:93](https://github.com/theVedanta/pacer/blob/main/packages/react-pacer/src/throttler/useThrottledState.ts#L93)
