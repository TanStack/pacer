...
Defined in: [solid-pacer/src/rate-limiter/createRateLimitedValue.ts:97](https://github.com/theVedanta/pacer/blob/main/packages/solid-pacer/src/rate-limiter/createRateLimitedValue.ts#L97)
