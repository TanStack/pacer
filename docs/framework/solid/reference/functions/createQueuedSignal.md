...
Defined in: [solid-pacer/src/queuer/createQueuedSignal.ts:119](https://github.com/theVedanta/pacer/blob/main/packages/solid-pacer/src/queuer/createQueuedSignal.ts#L119)
