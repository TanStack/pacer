...
Defined in: [solid-pacer/src/queuer/createQueuedSignal.ts:119](https://github.com/klink-ing/pacer/blob/main/packages/solid-pacer/src/queuer/createQueuedSignal.ts#L119)
