...
Defined in: [packages/solid-pacer/src/throttler/createThrottler.ts:37](https://github.com/TanStack/pacer/blob/main/packages/solid-pacer/src/throttler/createThrottler.ts#L37)
