...
```ts
function useRateLimitedValue<TValue>(value, options): readonly [Accessor<TValue>, Accessor<{
...
Defined in: [packages/solid-pacer/src/rate-limiter/useRateLimitedValue.ts:52](https://github.com/TanStack/pacer/blob/main/packages/solid-pacer/src/rate-limiter/useRateLimitedValue.ts#L52)
