...
Defined in: [solid-pacer/src/rate-limiter/createRateLimitedSignal.ts:95](https://github.com/theVedanta/pacer/blob/main/packages/solid-pacer/src/rate-limiter/createRateLimitedSignal.ts#L95)
