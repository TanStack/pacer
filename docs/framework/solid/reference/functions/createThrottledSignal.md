...
Defined in: [solid-pacer/src/throttler/createThrottledSignal.ts:69](https://github.com/klink-ing/pacer/blob/main/packages/solid-pacer/src/throttler/createThrottledSignal.ts#L69)
