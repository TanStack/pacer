...
Defined in: [packages/solid-pacer/src/rate-limiter/useRateLimitedCallback.ts:50](https://github.com/TanStack/pacer/blob/main/packages/solid-pacer/src/rate-limiter/useRateLimitedCallback.ts#L50)
