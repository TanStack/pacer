...
Defined in: [packages/solid-pacer/src/throttler/useThrottledCallback.ts:41](https://github.com/TanStack/pacer/blob/main/packages/solid-pacer/src/throttler/useThrottledCallback.ts#L41)
