...
Defined in: [solid-pacer/src/rate-limiter/createRateLimiter.ts:185](https://github.com/ghostd/pacer/blob/main/packages/solid-pacer/src/rate-limiter/createRateLimiter.ts#L185)
