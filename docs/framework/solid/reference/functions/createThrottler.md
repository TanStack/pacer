...
Defined in: [solid-pacer/src/throttler/createThrottler.ts:159](https://github.com/ghostd/pacer/blob/main/packages/solid-pacer/src/throttler/createThrottler.ts#L159)
