...
Defined in: [solid-pacer/src/throttler/createThrottler.ts:136](https://github.com/theVedanta/pacer/blob/main/packages/solid-pacer/src/throttler/createThrottler.ts#L136)
