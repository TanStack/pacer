...
Defined in: [async-rate-limiter.ts:55](https://github.com/TanStack/pacer/blob/main/packages/pacer/src/async-rate-limiter.ts#L55)
...
`Partial`\<[`AsyncRateLimiterOptions`](../interfaces/asyncratelimiteroptions.md)\>
