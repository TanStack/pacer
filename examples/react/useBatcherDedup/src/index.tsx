  ...
  return (
    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
      ...
      <p>
        ...
        Once an item is processed, it won't be processed again until you clear the history.
      </p>
      ...
      >
        ...
        <p style={{ fontSize: "14px", color: "#666" }}>
          Click buttons to request user data. Items that have already been processed
      ...
      >
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li>
            <strong>deduplicateItems: true</strong> enables both in-batch and cross-batch deduplication
          </li>
          <li>
            Within a batch: duplicates are merged using <code>deduplicateStrategy</code>
          </li>
          <li>
            Across batches: once processed, items are tracked in <code>processedKeys</code>
          </li>
          <li>
            <code>maxTrackedKeys: 100</code> limits memory usage (oldest keys are evicted first)
          </li>
          <li>
            Use <strong>Clear Processed Keys</strong> to allow re-processing of previously processed items
          </li>
          <li>
