      ...
      <table>
        <tbody>
          <tr>
            ...
            <td>{setCountThrottler.store.executionCount}</td>
          </tr>
          <tr>
            <td>Instant Count:</td>
            <td>{instantCount()}</td>
    ...
    <div>
      ...
      <table>
        <tbody>
          <tr>
            <td>Execution Count:</td>
            <td>{setSearchThrottler.store.executionCount}</td>
          </tr>
          <tr>
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>{setValueThrottler.store.executionCount}</td>
          </tr>
          <tr>
            <td>Saved Executions:</td>
            <td>
              {instantExecutionCount() - setValueThrottler.store.executionCount}
            </td>
          </tr>
          <tr>
            <td>% Reduction:</td>
              ...
              {instantExecutionCount() === 0
                ...
                : Math.round(
                    ((instantExecutionCount() -
                      setValueThrottler.store.executionCount) /
                      instantExecutionCount()) *
                      100,
                  )}
              %
