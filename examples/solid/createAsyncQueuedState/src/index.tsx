...
import { createAsyncQueuedState } from '@tanstack/solid-pacer/async-queuer'
...
function App() {
  ...
  const [queueItems, asyncQueuer] = createAsyncQueuedState(
  ...
  return (
    <div>
      <h1>TanStack Pacer createAsyncQueuedState Example</h1>
      <div></div>
