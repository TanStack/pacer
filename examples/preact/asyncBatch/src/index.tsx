...
import { asyncBatch } from '@tanstack/preact-pacer/async-batcher'
...
function App() {
  ...
  const addToBatch = useCallback(
    ...
    [], // must be memoized to avoid re-creating the batcher on every render (consider using useAsyncBatcher instead in preact)
  )
        ...
        <div>
          <label>
            <input
              type="checkbox"
              checked={shouldFail}
              onInput={(e) => setShouldFail(e.currentTarget.checked)}
            />{' '}
