...
import { throttle } from '@tanstack/preact-pacer/throttler'
...
function App1() {
  ...
  const throttledSetCount = useCallback(
    ...
    [], // must be memoized to avoid re-creating the throttler on every render (consider using useThrottler instead in preact)
  )
